from libs.seidel_method import *
import argparse


def setup_argparse():
    parser = argparse.ArgumentParser(description=
                                     "Solve a system of linear equations with Seidel method")
...
if __name__ == "__main__":
    ...
    try:
        ...
        sys.exit(1)
    seidel_m = SeidelMethod(m, v)
    seidel_m.log(args.verbose)
    print(seidel_m.solve(args.precision))
