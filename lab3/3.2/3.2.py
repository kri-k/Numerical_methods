import sys
import argparse
from libs.spline_interpolation import SplineInterpolation
...
if __name__ == "__main__":
    ...
    for line in file:
        ...
        if l[0] == '?':
            ...
            py.append(float(l[1]))
    file.close()
    spl = SplineInterpolation(*zip(px, py))
    ...
    if args.plot:
        ...
        plt.xlabel('x')
        plt.ylabel('y')
        plt.title('Interpolating cubic spline for "{}"'.format(args.points_file))
        plt.grid(True)
