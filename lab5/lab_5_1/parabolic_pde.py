...
from lab_5_1.finite_difference.explicit_method import explicit_fd
from lab_5_1.finite_difference.implicit_method import implicit_fd
from lab_5_1.finite_difference.crank_nicolson_method import crank_nicolson_fd
...
class ParabolicPDE:
    ...
    def solve_explicit_method(self, step_x, step_t, boundary_approximation_func):
    ...
    def solve_implicit_method(self, step_x, step_t, boundary_approximation_func):
